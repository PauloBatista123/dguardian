  ...
  <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between p-4">
    <div class="flex justify-between flex-1 sm:hidden gap-2">
      <span>
        ...
        <span class="relative inline-flex items-center p-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md select-none gap-1">
      ...
      <span>
        ...
        @else
        <span class="relative inline-flex items-center p-2 gap-1 ml-3 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md select-none">
    ...
    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between gap-2">
      <div>
        <p class="text-sm text-gray-600 ">
          ...
          <span class="font-semibold text-verdeescuro ">{{ $paginator->firstItem() }}</span>
          <span>{!! __('para') !!}</span>
          <span class="font-semibold text-verdeescuro ">{{ $paginator->lastItem() }}</span>
          <span>{!! __('de') !!}</span>
          <span class="font-semibold text-verdeescuro ">{{ $paginator->total() }}</span>
        ...
        <span class="relative z-0 inline-flex rounded-md shadow-sm">
          ...
          <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
            ...
            <span aria-current="page">
              <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-verdeescuro border border-gray-300 cursor-default leading-5 select-none">{{ $page }}</span>
            </span>
            @else

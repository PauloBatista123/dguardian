...
<div class="min-h-screen min-w-full flex justify-center content-center items-center bg-gradient-to-r from-[#0E3642] from-50% via-[#0E3642] to-[#0E3642]">
  <div class="w-full h-screen flex">
    {{-- form login --}}
    <div class="min-w-[38em] h-screen flex flex-col justify-between bg-gradient-to-tr border-r-2 border-r-white from-zinc-100 to-slate-50 rounded-tr-[8px] rounded-br-[8px]  shadow-lg shadow-white dark:from-gray-900 dark:to-gray-800 dark:border-gray-700">
      <div class="p-10">
        ...
        <div>
          ...
          <div class="w-50 mt-4">
            ...
            <a type="button" href="{{route('login.microsoft')}}" class="text-center min-w-full relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-roxo to-blue-500 group-hover:from-roxo group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
              <span class="min-w-full relative px-5 py-2.5 transition-all ease-in duration-75 text-verdeescuro bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
    ...
    {{-- slide rigth --}}
    <div class="flex flex-1 bg-cover bg-no-repeat" style="background-image: url(/background-dark.svg)">
      <div class="flex flex-1 items-center justify-center bg-verdeescuro/80">
        <div class="grid grid-cols-2 w-[48rem] gap-32 items-start">

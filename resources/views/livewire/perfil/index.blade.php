        ...
        <div class="flex flex-row border-b p-4 justify-between">
          ...
          <div class="flex flex-col align-content-end">
            <div class="py-1 text-end">
              ...
              <button data-tooltip-target="tooltip-excluir" wire:click="excluir('{{$item->id}}')" type="button" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2">

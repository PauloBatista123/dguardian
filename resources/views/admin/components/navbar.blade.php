  ...
  <div class="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-verdeescuro md:bg-verdeescuro border-verdeescuro">
        <a href="{{route('home')}}">
          <li class="flex gap-1 items-center @if(\URL::current() == \URL::route('home')) md:text-verdemedio @else md:text-white @endif md:hover:text-verdeclaro">
            <svg class="w-4 h-4 group-hover:text-verdeclaro" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8v10a1 1 0 0 0 1 1h4v-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5h4a1 1 0 0 0 1-1V8M1 10l9-9 9 9" />
            </svg>
            <span class=" block py-2 pl-3 pr-4 rounded md:p-0 border-gray-700 group-hover:text-verdeclaro">Início</span>
          </li>
        </a>
        <a href="{{route('usuarios.listar')}}">
          <li class="flex gap-1 items-center @if(\URL::current() == \URL::route('usuarios.listar')) md:text-verdemedio @else md:text-white @endif group">
            <svg class="w-4 h-4 hover:text-white group-hover:text-verdeclaro" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.333 6.764a3 3 0 1 1 3.141-5.023M2.5 16H1v-2a4 4 0 0 1 4-4m7.379-8.121a3 3 0 1 1 2.976 5M15 10a4 4 0 0 1 4 4v2h-1.761M13 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-4 6h2a4 4 0 0 1 4 4v2H5v-2a4 4 0 0 1 4-4Z" />
            </svg>
            <span class=" block py-2 pl-3 pr-4 rounded md:p-0 border-gray-700 group-hover:text-verdeclaro">Usuários</span>
          </li>
        </a>
        <a href="{{route('clientes.listar')}}">
          <li class="flex gap-1 items-center
          @if(
          \Route::currentRouteName() == 'clientes.listar' ||
          \Route::currentRouteName() == 'clientes.perfis' ||
          \Route::currentRouteName() == 'clientes.perfis.permissoes'
          ) md:text-verdemedio @else md:text-white @endif group">
            <svg class="w-4 h-4 hover:text-white group-hover:text-verdeclaro" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.951-1.488A3.987 3.987 0 0 0 11 14H9a3.987 3.987 0 0 0-3.951 3.512A8.948 8.948 0 0 0 10 19Zm3-11a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            </svg>
            <span class=" block py-2 pl-3 pr-4 rounded md:p-0 border-gray-700 group-hover:text-verdeclaro">Clientes</span>
          </li>
        </a>
        <a href="{{route('ausencias.listar')}}">
          <li class="flex gap-1 items-center @if(\URL::current() == \URL::route('ausencias.listar')) md:text-verdemedio @else md:text-white @endif group">
            <svg class="w-4 h-4 hover:text-white group-hover:text-verdeclaro" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 18">
            ...
            <span class=" block py-2 pl-3 pr-4 rounded md:p-0 border-gray-700 group-hover:text-verdeclaro">Ausências</span>
          </li>
        </a>
        <a href="{{route('sessoes.listar')}}">
          <li class="flex gap-1 items-center @if(\URL::current() == \URL::route('sessoes.listar')) md:text-verdemedio @else md:text-white @endif group">
            <svg class="w-4 h-4 hover:text-white group-hover:text-verdeclaro" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class=" block py-2 pl-3 pr-4 rounded md:p-0 border-gray-700 group-hover:text-verdeclaro">Sessões</span>
          </li>
        </a>
      </ul>
    </div>
